...
<span className="quick-eyebrow">منصة هديل</span>
  ...
  <style jsx>{`
    ...
    .quick-eyebrow {
      ...
      padding: 6px 16px;
      margin-bottom: 12px;
      border: 1px solid rgba(226, 164, 61, 0.35);
      border-radius: 999px;
    ...
    .quick-heading h2 {
      ...
      text-shadow: 0 2px 10px rgba(226, 164, 61, 0.12);
    }
    ...
    .quick-card {
      ...
      box-shadow:
        0 14px 38px rgba(23, 35, 61, 0.08),
        0 3px 10px rgba(36, 85, 196, 0.04);
    ...
    .quick-card:hover {
      ...
      box-shadow:
        0 22px 50px rgba(23, 35, 61, 0.12),
    ...
    .quick-card:focus-visible {
      outline: 3px solid rgba(36, 85, 196, 0.28);
      outline-offset: 4px;
    }
