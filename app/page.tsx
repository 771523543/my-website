...
export default function Page() {
  ...
  useEffect(() => {
    ...
    const timer = window.setInterval(() => {
      setAchievementIndex(
        (current) => (current + 1) % achievementImages.length
      )
    }, 3000)
    ...
    >
      ...
      <header className="site-header">
        <div className="container nav-wrap">
          <a className="brand" href="#top">
            ...
            <span>
              منصة هديل<span className="brand-dot">.</span>
            </span>
          </a>
        ...
        <div className="hero-copy">
          ...
          <div className="trust-row">
            ...
            <div>
              ...
              <small>طالب وباحث يثقون بنا</small>
            </div>
          </div>
      ...
      <section id="story" className="section story-section container">
        ...
        <div className="story-copy">
          ...
          <p>
            انطلقت منصة هديل لتكون الوجهة الموثوقة للطلاب والباحثين،
            وتحوّل التحديات الأكاديمية إلى خطوات واضحة قابلة للإنجاز.
            نعمل بشغف لنقدم حلولًا احترافية تراعي احتياجك وتساعدك على
            إكمال رحلتك بأعلى درجات الجودة.
          </p>
      ...
      >
        <div className="center-heading">
          ...
          <h2>
            حاسبة <em>المعدل التراكمي (GPA)</em>
          </h2>

          <p>
            احسب معدلك الفصل المتوقع بسهولة ودقة وفق السلم الأكاديمي
            المعتمد.
          </p>
        </div>
          ...
          >
            <button
              ...
              style={{
                ...
                background:
                  gpaSystem === 5 ? '#10b981' : '#fff',
                color: gpaSystem === 5 ? '#fff' : '#333',
                fontWeight: 'bold',
                cursor: 'pointer',
              }}
            >
            ...
            <button
              ...
              style={{
                ...
                border: '1px solid #10b981',
                background:
                  gpaSystem === 4 ? '#10b981' : '#fff',
                color: gpaSystem === 4 ? '#fff' : '#333',
                fontWeight: 'bold',
                cursor: 'pointer',
              }}
            >
      ...
      <section id="testimonials" className="section container">
        <div className="center-heading">
          ...
          <h2>
            ماذا يقول <em>طلابنا عنّا؟</em>
          </h2>

          <p>
            تجارب حقيقية لطلاب وباحثين اعتمدوا على منصتنا لتسيير
            أبحاثهم ومسيرتهم الأكاديمية.
          </p>
        </div>
      ...
      <section className="academic-ad-section container">
        <div className="academic-ad">
          ...
          <p>
            من إعداد البحوث الموثقة إلى إدارة حساب البلاك بورد،
            تقدم لك منصة هديل كافة الأدوات والخدمات التي توفر وقتك
            وتضمن لك التفوق الأكاديمي.
          </p>
      ...
      <section className="achievements-section container">
        <div className="achievements-copy">
          ...
          <p>
            نفخر بكل طالب ساعدناه على تحويل التحديات الأكاديمية إلى
            إنجازات واضحة ونتائج ملموسة.
          </p>
      ...
      <section id="why" className="why-section">
        <div className="container why-inner">
          <div>
            ...
            <p>
              فريق متخصص، تواصل واضح، وجودة نراجعها معك خطوة بخطوة.
            </p>
          </div>
          ...
          <div className="feature-list">
            <div>
              ...
              <span>
                <strong>سرعة فائقة في الإنجاز</strong>
                <small>تنفيذ وتسليم في وقت قياسي.</small>
              </span>
            </div>
            ...
            <div>
              ...
              <span>
                <strong>جودة أكاديمية عالية</strong>
                <small>
                  مراجعة تدقيقية متكاملة لجميع الأعمال.
                </small>
              </span>
            </div>
            ...
            <div>
              ...
              <span>
                <strong>دعم ومتابعة مستمرة</strong>
                <small>
                  تواصل وتعديل حتى اعتماد العمل نهائيًا.
                </small>
              </span>
            </div>
          </div>
      ...
      <section id="faq" className="section container">
        <div className="center-heading">
          ...
          <p>
            إليك إجابات لأبرز الأسئلة والاستفسارات الشائعة حول
            خدماتنا وطريقة التعامل.
          </p>
        </div>
