    ...
    <main dir="rtl" className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      <section id="services" data-reveal className="section container reveal-section">
        ...
        <div style={{ display: 'flex', gap: '0.6rem', marginBottom: '1.5rem', flexWrap: 'wrap', justifyContent: 'center' }}>
          ...
          <button onClick={() => setActiveCategory('design')} style={{ padding: '0.5rem 1.2rem', borderRadius: '20px', border: '1px solid #10b981', background: activeCategory === 'design' ? '#10b981' : 'transparent', color: activeCategory === 'design' ? '#fff' : 'inherit', fontWeight: 'bold', cursor: 'pointer', fontSize: '0.88rem' }}>تصاميم وعروض</button>
        ...
        {selectedDetailService && (
          ...
          >
            <section 
              ...
              style={{ backgroundColor: '#fff', borderRadius: '16px', padding: '1.8rem', width: '100%', maxWidth: '650px', maxHeight: '90vh', overflowY: 'auto', position: 'relative', boxShadow: '0 20px 25px -5px rgba(0, 0, 0, 0.1)', direction: 'rtl' }}
            >
              <button 
              ...
              <div style={{ display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', gap: '8px', marginBottom: '1rem', textAlign: 'center' }}>
                ...
                <h2 style={{ fontSize: '1.3rem', fontWeight: 'bold', textAlign: 'center' }}>{selectedDetailService.title}</h2>
              </div>
                ...
                <div style={{ marginBottom: '1.2rem' }}>
                  ...
                  {selectedDetailService.faqs.map((faq, idx) => (
                    <div key={idx} style={{ marginBottom: '0.6rem', padding: '0.6rem 0.8rem', background: '#f8fafc', borderRadius: '6px', textAlign: 'center' }}>
                      ...
                      <span style={{ fontSize: '0.85rem', color: '#555' }}>{faq.a}</span>
                    </div>
                  ))}
                </div>
              )}
              ...
              <div>
                <h3 style={{ fontSize: '1.05rem', marginBottom: '0.8rem', color: '#111', display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', fontWeight: 'bold' }}>
                ...
                <form onSubmit={(e) => { e.preventDefault(); handleSendToWhatsapp(); }} style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem' }}>
                  ...
                  <div>
                    ...
                    <textarea rows={3} placeholder="أدخل أي شروط خاصة أو موعد التسليم..." value={formData.notes} onChange={(e) => setFormData({ ...formData, notes: e.target.value })} style={{ width: '100%', padding: '0.5rem 0.75rem', borderRadius: '6px', border: '1px solid #ccc', fontSize: '0.88rem' }} />
                  </div>
                  <button type="submit" style={{ display: 'flex', alignItems: 'center', justifyContent: 'center', gap: '6px', background: '#25D366', color: '#fff', border: 'none', padding: '0.75rem', borderRadius: '8px', fontWeight: 'bold', fontSize: '0.95rem', cursor: 'pointer', marginTop: '0.4rem' }}>
