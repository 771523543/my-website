...
export default function Page() {
  ...
  return (
    <main dir="rtl" className="min-h-screen overflow-hidden bg-background text-foreground">
      ...
      {/* قسم الخدمات مع الفلتر وزر المشاركة */}
      <section id="services" data-reveal className="section container reveal-section">
        ...
        <div className="service-grid">
          {filteredServices.map((service) => {
            ...
            return (
              <article key={service.id} className="service-card reveal-section" data-reveal style={{ position: 'relative' }}>
                <button 
                ...
                <div className="service-content" style={{ padding: '1.5rem 1rem 1rem', textAlign: 'right' }}>
                  <div style={{ textAlign: 'right' }}>
                    <span className="service-icon" style={{ display: 'inline-flex', marginBottom: '0.5rem' }}><Icon size={24} /></span>
                    <h3 style={{ fontSize: '1.2rem', marginTop: '0.3rem', fontWeight: 'bold', textAlign: 'right' }}>{service.title}</h3>
                    <p style={{ margin: '0.6rem 0 1.2rem', fontSize: '0.92rem', color: '#111827', lineHeight: '1.6', fontWeight: '500', textAlign: 'right', direction: 'rtl' }}>
                      {service.shortText}
                    </p>
                  </div>
                  <button 
